...
<div className=' mx-2 md:mx-10 p-10  grid grid-cols-1 md:grid-cols-2 gap-5 items-center justify-between '>
              <div className='transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-95'>
                  <img src="https://firebasestorage.googleapis.com/v0/b/dphospens.appspot.com/o/Slider%2FDPHOSPen%20slider4_editing_052210.jpg?alt=media&token=39bf95eb-52f0-4ce8-ad50-e87d2c9fd0b4" alt="" />
                </div>

        <div className=' max-w-3xl  transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-70'> 
                    <p className='lg:text-3xl font-semibold'>SUBMIT YOUR STORY WITH US</p>
...
<div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg max-w-lg mx-auto mt-10">
      <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-4">
        SUBMIT A STORY WITH US:
      </h2>
      <p className="text-sm sm:text-base text-gray-700 mb-6">
        We are confident that with our writers' guidance, support, and
        commitment to excellence, members will thrive academically and reach
        their educational goals.
      </p>
      <button className="w-full sm:w-auto bg-purple-700 text-white px-6 py-2 rounded-md hover:bg-purple-800 transition">
        SUBMIT
      </button>
    </div>
    </div>
