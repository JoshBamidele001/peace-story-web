...
export default function CalltoAction() {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-[60%_40%] border-2 border-purple-300 rounded-tl-3xl rounded-br-3xl shadow-md'>
      {/* Call to action textr */}
      <div className='px-14 py-6'> 
        <h2 className='lg:text-3xl text-purple-800 font-semibold '> Unleash Your Creativity!</h2>
        ...
        <button className='btn bg-purple-400 px-3 py-2  rounded-tl-xl rounded-br-xl my-4 hover:bg-transparent hover:text-purple-800 hover:border-purple-900 hover:border'>
